...
- **Seguridad:** Netlify Edge Functions (streaming SSE) + Netlify Functions normales (get-key).
...
2. **Proxy de Chat:** Edge Function `gemini-stream.js` con streaming SSE (sin límite de timeout).
...
- `netlify/edge-functions/gemini-stream.js`: Proxy streaming SSE hacia Gemini.
...
- [x] **Seguridad & Streaming:** Proxy migrado a Edge Functions (SSE) eliminando timeouts 504.
